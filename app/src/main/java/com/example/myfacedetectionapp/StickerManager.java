...
public class StickerManager {
   ...
   */
  public static StickerBufferProto.StickerRoll getMessageLiteData(
    ArrayList<StickerManager> stickerArrayList) {
    StickerBufferProto.StickerRoll.Builder stickerRollBuilder
      = StickerBufferProto.StickerRoll.newBuilder();
    for (final StickerManager sticker : stickerArrayList) {
      StickerBufferProto.Sticker protoSticker =
          StickerBufferProto.Sticker.newBuilder()
